...
export const mapDiagnosticsToMcpViewState = (
  ...
  setupLabel: diagnostics.setupLabel,
  setupTransportUrl: diagnostics.setupUrl ?? diagnostics.url ?? '',
  setupAuthToken: diagnostics.setupToken ?? diagnostics.token,
  setupRegistrationFile: diagnostics.setupRegistrationFile ?? diagnostics.registrationFile ?? '',
  transportUrl: diagnostics.url ?? '',
  host: diagnostics.host,
  port: diagnostics.port,
  authToken: diagnostics.token,
  ...
  activeToolCalls: diagnostics.activeToolCalls,
  busySince: diagnostics.busySince,
  lastBusyAt: diagnostics.lastBusyAt,
  agentActivity: diagnostics.agentActivity ? { ...diagnostics.agentActivity } : null,
